...
void ProcessAsyncKeys(GLFWwindow* window)
{
	...
	if (AreAllModifiersUp(window))
	{
		...
		//if (glfwGetKey(window, GLFW_KEY_W)) { pTheShip->velocity.z = speed; pTheShip->velocity = glm::rotate(pTheShip->getQOrientation(), pTheShip->velocity); }
		//if (glfwGetKey(window, GLFW_KEY_S)) { pTheShip->velocity.z = -speed; pTheShip->velocity = glm::rotate(pTheShip->getQOrientation(), pTheShip->velocity); }
		//if (glfwGetKey(window, GLFW_KEY_A)) { pTheShip->velocity.x = speed; pTheShip->velocity = glm::rotate(pTheShip->getQOrientation(), pTheShip->velocity); }
		//if (glfwGetKey(window, GLFW_KEY_D)) { pTheShip->velocity.x = -speed; pTheShip->velocity = glm::rotate(pTheShip->getQOrientation(), pTheShip->velocity); }
		//if (glfwGetKey(window, GLFW_KEY_Q)) { pTheShip->velocity.y = -speed; pTheShip->velocity = glm::rotate(pTheShip->getQOrientation(), pTheShip->velocity); }
		//if (glfwGetKey(window, GLFW_KEY_E)) { pTheShip->velocity.y = speed; pTheShip->velocity = glm::rotate(pTheShip->getQOrientation(), pTheShip->velocity); }
		...
		if (glfwGetKey(window, GLFW_KEY_J)) { pTheShip->adjMeshOrientationEulerAngles(glm::vec3(glm::radians(0.0f), glm::radians(10.0f), glm::radians(0.0f)), true); 
		::g_pFlyCamera->adjMeshOrientationEulerAngles(glm::vec3(glm::radians(0.0f), glm::radians(10.0f), glm::radians(0.0f)), true);
		}
		if (glfwGetKey(window, GLFW_KEY_L)) { pTheShip->adjMeshOrientationEulerAngles(glm::vec3(glm::radians(0.0f), glm::radians(-10.0f), glm::radians(0.0f)), true); 
		::g_pFlyCamera->adjMeshOrientationEulerAngles(glm::vec3(glm::radians(0.0f), glm::radians(-10.0f), glm::radians(0.0f)), true);
		}
		if (glfwGetKey(window, GLFW_KEY_U)) { pTheShip->adjMeshOrientationEulerAngles(glm::vec3(glm::radians(0.0f), glm::radians(0.0f), glm::radians(-10.0f)), true); 
		::g_pFlyCamera->adjMeshOrientationEulerAngles(glm::vec3(glm::radians(0.0f), glm::radians(0.0f), glm::radians(-10.0f)), true);
		}
		if (glfwGetKey(window, GLFW_KEY_O)) { pTheShip->adjMeshOrientationEulerAngles(glm::vec3(glm::radians(0.0f), glm::radians(0.0f), glm::radians(10.0f)), true);
		::g_pFlyCamera->adjMeshOrientationEulerAngles(glm::vec3(glm::radians(0.0f), glm::radians(0.0f), glm::radians(10.0f)), true);
		}
